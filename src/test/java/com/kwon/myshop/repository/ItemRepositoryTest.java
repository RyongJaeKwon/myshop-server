...
public class ItemRepositoryTest {
    ...
    public void saveItemTest() throws Exception {
        ...
        //then
        Item savedItem = itemRepository.findById(createItem.getId()).orElseThrow(() -> new ItemNotFoundException());
    ...
    public void getItemListByIdTest() throws Exception {
        ...
        Assertions.assertNull(itemList.get(5));
...
//            itemRepository.save(item);
//        }
        Pageable pageable = PageRequest.of(1, 10, Sort.by("regDate").descending());

        //when
        Page<Object[]> itemList = itemRepository.findRecentItemListWithCategory(pageable, "top");
        itemList.getContent().forEach(items -> log.info(Arrays.toString(items)));

        List<Object[]> content = itemList.getContent();
...
//        }
    ...
    public void updateItemTest() throws Exception {
        ...
        //then
        Item updateItem = itemRepository.findById(savedItem.getId()).orElseThrow(() -> new ItemNotFoundException());

        Assertions.assertNotNull(updateItem);
        Assertions.assertEquals(createItem.getId(), updateItem.getId());
        Assertions.assertNotEquals(createItem.getItemName(), updateItem.getItemName());
        Assertions.assertNotEquals(createItem.getItemInfo(), updateItem.getItemInfo());
        Assertions.assertNotEquals(createItem.getPrice(), updateItem.getPrice());
        Assertions.assertNotEquals(createItem.getColor(), updateItem.getColor());
        Assertions.assertNotEquals(createItem.getBrand(), updateItem.getBrand());
        Assertions.assertNotEquals(createItem.getCategory(), updateItem.getCategory());
        Assertions.assertNotEquals(createItem.getSize(), updateItem.getSize());
    }
